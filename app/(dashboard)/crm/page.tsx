...
function SourceIcon({ source, size = 14 }: { source: string | null; size?: number }) {
  ...
  // WhatsApp icon — direto, campanha, ou legado
  // Tudo que chega pelo webhook do WhatsApp é WhatsApp (verde)
  ...
  // Meta Ads legado (campanha) — ícone Facebook azul
  if (source === 'campanha') {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className="shrink-0">
